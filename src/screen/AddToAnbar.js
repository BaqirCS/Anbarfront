...
import { anbarInputReducer, initialState } from '../reducers/AnbarInputReducer';
...
function AddToAnbar() {
  ...
  const [state, dispatch] = useReducer(anbarInputReducer, initialState);
  ...
  return (
    <div className="container mt-4">
      {state.loading ? (
        ...
        <>
          <h2 className="text-center mb-5  ">اضافه کردن جنس به انبار</h2>
